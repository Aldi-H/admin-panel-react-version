...
const Topbar = (props: NavbarProps) => {
  ...
  return (
    <div
      className={`bg-background fixed backdrop-filter backdrop-blur-lg bg-opacity-30 border-b-[1.5px] border-secondary rounded-xl leading-6 flex min-h-20 xl:justify-center xl:items-center mx-auto mt-0 pb-2 right-3 md:right-7 lg:right-7 xl:right-10 ps-5 pt-2 top-3 md:top-4 xl:top-5 
      ${
        isCollapsed
